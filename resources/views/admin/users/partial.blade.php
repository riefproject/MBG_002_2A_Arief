{{-- Partial view untuk konten admin users tanpa layout --}}
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
        ...
        <!-- Users Table -->
        <x-table.wrapper 
            :headers="['User', 'Role', 'Terdaftar', 'Status', 'Aksi']"
            empty-message="Belum ada user yang terdaftar">
...
<x-modal.base id="modal-hapus" title="Konfirmasi Hapus" size="sm">
    <div class="text-center">
        ...
        <h3 class="mt-2 text-lg font-medium text-gray-900">Hapus User</h3>
...
// Note: Form validation and AJAX submission is now handled by ajax-forms.js
// This keeps the page clean and modular
</script>
@endpush